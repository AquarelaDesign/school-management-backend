...
const createCourseUnit = asyncHandler(async (req, res) => {
...
// @access  Public
const getAllCourseUnits = asyncHandler(async (req, res) => {
...
// @access  Public
const getCourseUnitById = asyncHandler(async (req, res) => {
...
// @access  Private (if authentication is required)
const updateCourseUnit = asyncHandler(async (req, res) => {
  const { name, code, description, course } = req.body;
...
// @access  Private (if authentication is required)
const deleteCourseUnit = asyncHandler(async (req, res) => {
  const courseUnit = await CourseUnit.findById(req.params.id);
